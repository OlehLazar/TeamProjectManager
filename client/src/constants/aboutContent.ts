export const aboutContent = [
    {
      ...
      text: "We believe in empowering teams to achieve their full potential. Our platform is designed to streamline collaboration, boost productivity, and simplify project management. We're passionate about creating a user-friendly and intuitive experience that helps teams of all sizes work smarter, not harder.",
      image: {
